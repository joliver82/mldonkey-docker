...
if [ ! -f /var/lib/mldonkey/downloads.ini ]; then
    ...
    sleep 5
    /usr/lib/mldonkey/mldonkey_command -p "" "set client_name Random-ED2K-Client" "save"
    ...
    /usr/lib/mldonkey/mldonkey_command -p "" "set enable_directconnect true" "save"
    ...
    /usr/lib/mldonkey/mldonkey_command -p "" "set max_upload_slots 16" "save"
    /usr/lib/mldonkey/mldonkey_command -p "" "set ED2K-connect_only_preferred_server false" "save"
    /usr/lib/mldonkey/mldonkey_command -p "" "set ED2K-max_connected_servers 6" "save"
    /usr/lib/mldonkey/mldonkey_command -p "" "set ED2K-min_left_servers 10" "save"
    ...
    /usr/lib/mldonkey/mldonkey_command -p "" "set max_concurrent_downloads 256" "save"
    ...
    /usr/lib/mldonkey/mldonkey_command -p "" "set upnp_port_forwarding true" "save"
    /usr/lib/mldonkey/mldonkey_command -p "" "set max_opened_connections 1024" "save"
    /usr/lib/mldonkey/mldonkey_command -p "" "set max_connections_per_second 32" "save"
    ...
    /usr/lib/mldonkey/mldonkey_command -p "" "urladd guarding.p2p http://www.bluetack.co.uk/config/level1.gz 250" "save"
    /usr/lib/mldonkey/mldonkey_command -p "" "urladd guarding.p2p http://list.iblocklist.com/?list=ydxerpxkpcfqjaybcssw&fileformat=p2p&archiveformat=gz 250" "save"
